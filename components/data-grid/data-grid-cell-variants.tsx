  ...
  return (
    ...
    >
      <div
        ...
        className={cn("overflow-hidden outline-none", {
  ...
  return (
    ...
    >
      {!isEditing && displayValue ? (
        <div data-slot="grid-cell-content" className="overflow-hidden">
          <a
    ...
    >
      {isEditing ? (
        ...
        >
          <SelectTrigger
            size="sm"
            className="items-start border-none p-0 shadow-none focus-visible:ring-0 dark:bg-transparent [&_svg]:hidden"
          >
            {displayLabel ? (
              <Badge
                variant="secondary"
